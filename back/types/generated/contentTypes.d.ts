...
export interface ApiCartItemCartItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    discount_price: Attribute.Decimal & Attribute.DefaultTo<0>;
    total: Attribute.Decimal & Attribute.Required;
    product_name: Attribute.String;
    is_variant: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user_interests: Attribute.Relation<
      'api::category.category',
      'oneToMany',
    ...
    categories: Attribute.Relation<
      ...
      'api::category.category'
    >;
    nbrs_products: Attribute.Integer & Attribute.DefaultTo<0>;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    quantity: Attribute.BigInteger &
      Attribute.Required &
      Attribute.DefaultTo<'0'>;
    is_vip: Attribute.Boolean & Attribute.DefaultTo<false>;
    ...
    customer: Attribute.Relation<
      ...
      'api::customer.customer'
    >;
    product_variant: Attribute.Component<'product.product-variant', true>;
...
export interface ApiUserInterestUserInterest extends Schema.CollectionType {
  collectionName: 'user_interests';
  info: {
    singularName: 'user-interest';
    pluralName: 'user-interests';
    displayName: 'UserInterest';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-interest.user-interest': ApiUserInterestUserInterest;
